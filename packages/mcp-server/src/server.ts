...
export { ClientOptions } from 'e-invoice-api';
...
async function getInstructions() {
  ...
  const response = await fetch(
    readEnv('CODE_MODE_INSTRUCTIONS_URL') ?? 'https://api.stainless.com/api/ai/instructions/e-invoice-api',
    {
      method: 'GET',
  ...
  if (!response.ok) {
    ...
    instructions = `
      This is the e-invoice-api MCP server. You will use Code Mode to help the user perform
