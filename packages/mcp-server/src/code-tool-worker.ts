...
import { EInvoice, ClientOptions } from 'e-invoice-api';
...
function getTSDiagnostics(code: string): string[] {
  ...
  const codeWithImport = [
    ...
    functionSource.type === 'declaration' ?
      `async function run(${functionSource.client}: EInvoice)`
    : `const run: (${functionSource.client}: EInvoice) => Promise<unknown> =`,
    functionSource.code,
  ].join('\n');
...
const fuse = new Fuse(
  [
    ...
    'client.documents.createFromPdf',
    'client.documents.delete',
    'client.documents.retrieve',
    'client.documents.send',
    'client.documents.validate',
    'client.documents.attachments.add',
    'client.documents.attachments.delete',
    'client.documents.attachments.list',
    'client.documents.attachments.retrieve',
    'client.documents.ubl.createFromUbl',
    'client.documents.ubl.get',
    'client.inbox.list',
    'client.inbox.listCreditNotes',
    'client.inbox.listInvoices',
    'client.outbox.listDraftDocuments',
    'client.outbox.listReceivedDocuments',
    'client.validate.validateJson',
    'client.validate.validatePeppolID',
    'client.validate.validateUbl',
    'client.lookup.retrieve',
    'client.lookup.retrieveParticipants',
    'client.me.retrieve',
