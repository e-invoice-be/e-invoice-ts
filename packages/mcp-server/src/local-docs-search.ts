...
const EMBEDDED_METHODS: MethodEntry[] = [
  {
    ...
    params: [
      ...
      "items?: { allowances?: { amount?: number | string; base_amount?: number | string; multiplier_factor?: number | string; reason?: string; reason_code?: string; tax_code?: 'AE' | 'E' | 'S' | 'Z' | 'G' | 'O' | 'K' | 'L' | 'M' | 'B'; tax_rate?: number | string; }[]; amount?: number | string; charges?: { amount?: number | string; base_amount?: number | string; multiplier_factor?: number | string; reason?: string; reason_code?: string; tax_code?: 'AE' | 'E' | 'S' | 'Z' | 'G' | 'O' | 'K' | 'L' | 'M' | 'B'; tax_rate?: number | string; }[]; date?: null; description?: string; item_attributes?: { name: string; value?: string; }[]; product_code?: string; quantity?: number | string; tax?: number | string; tax_rate?: number | string; unit?: string; unit_price?: number | string; }[];",
      'note?: string;',
