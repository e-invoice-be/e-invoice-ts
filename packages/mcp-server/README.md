...
[Open VS Code](https://vscode.stainless.com/mcp/%7B%22name%22%3A%22e-invoice-api-mcp%22%2C%22command%22%3A%22npx%22%2C%22args%22%3A%5B%22-y%22%2C%22e-invoice-api-mcp%22%5D%2C%22env%22%3A%7B%22E_INVOICE_API_KEY%22%3A%22My%20API%20Key%22%7D%7D)
...
```
claude mcp add e_invoice_api_mcp_api --env E_INVOICE_API_KEY="My API Key" -- npx -y e-invoice-api-mcp
```
